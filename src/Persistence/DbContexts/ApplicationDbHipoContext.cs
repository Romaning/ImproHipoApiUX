...
using Domain.Entities.Hipotina;
using Microsoft.EntityFrameworkCore;

namespace Persistence.DbContexts;

public partial class ApplicationDbHipoContext : DbContext
{
    public ApplicationDbHipoContext()
    {
    }

    public ApplicationDbHipoContext(DbContextOptions<ApplicationDbHipoContext> options)
        : base(options)
    {
        this.ChangeTracker.LazyLoadingEnabled = false;
    }

    public virtual DbSet<AccesoriosCambioProd> AccesoriosCambioProds { get; set; }

    public virtual DbSet<AccesoriosProd> AccesoriosProds { get; set; }
    ...
    public virtual DbSet<AltaProduccion> AltaProduccions { get; set; }

    public virtual DbSet<AltaProduccionDetalle> AltaProduccionDetalles { get; set; }
    ...
    public virtual DbSet<BajaProduccion> BajaProduccions { get; set; }

    public virtual DbSet<BajaProduccionDetalle> BajaProduccionDetalles { get; set; }
    ...
    public virtual DbSet<CodigoOrdenProduccion> CodigoOrdenProduccions { get; set; }

    public virtual DbSet<ColorProd> ColorProds { get; set; }
    ...
    public virtual DbSet<CostoPlantilla> CostoPlantillas { get; set; }

    public virtual DbSet<Cotizacion> Cotizacions { get; set; }

    public virtual DbSet<CotizacionItem> CotizacionItems { get; set; }

    public virtual DbSet<CotizacionItemsOp> CotizacionItemsOps { get; set; }
    ...
    public virtual DbSet<DetalleAccesorioCambio> DetalleAccesorioCambios { get; set; }
    ...
    public virtual DbSet<DominioValorAtributo> DominioValorAtributos { get; set; }
    ...
    public virtual DbSet<EquipamientoDetalle> EquipamientoDetalles { get; set; }

    public virtual DbSet<EquipamientoProd> EquipamientoProds { get; set; }
    ...
    public virtual DbSet<PedidoProduccion> PedidoProduccions { get; set; }

    public virtual DbSet<PedidoProduccionDetalle> PedidoProduccionDetalles { get; set; }
    ...
    public virtual DbSet<PedidoStock> PedidoStocks { get; set; }

    public virtual DbSet<PedidoStockItem> PedidoStockItems { get; set; }
    ...
    public virtual DbSet<PlantillaDetalle> PlantillaDetalles { get; set; }

    public virtual DbSet<PlantillaItemsOp> PlantillaItemsOps { get; set; }

    public virtual DbSet<PosicionFaldon> PosicionFaldons { get; set; }
    ...
    public virtual DbSet<ProductoGrafico> ProductoGraficos { get; set; }
    ...
    public virtual DbSet<RegistroProduccion> RegistroProduccions { get; set; }
    ...
    public virtual DbSet<SaldoInicialCliente> SaldoInicialClientes { get; set; }
    ...
    public virtual DbSet<StockItemsOp> StockItemsOps { get; set; }
    ...
    public virtual DbSet<TipoAccesorioCambio> TipoAccesorioCambios { get; set; }
    ...
    public virtual DbSet<TipoColorProd> TipoColorProds { get; set; }
    ...
    public virtual DbSet<TipoCostoPlantilla> TipoCostoPlantillas { get; set; }
    ...
    public virtual DbSet<TipoEquipamiento> TipoEquipamientos { get; set; }
    ...
    public virtual DbSet<TipoPosicionFaldon> TipoPosicionFaldons { get; set; }
    ...
    {
        modelBuilder.Entity<AccesoriosCambioProd>(entity =>
        {
            entity.HasKey(e => e.AccesoriosCambioProdId).HasName("PK_dbo.AccesoriosCambioProd");

            entity.ToTable("AccesoriosCambioProd");

            entity.HasIndex(e => e.ProdId, "IX_ProdId");

            entity.HasIndex(e => e.TipoAccesorioCambioId, "IX_TipoAccesorioCambioId");

            entity.HasOne(d => d.Prod).WithMany(p => p.AccesoriosCambioProds)
                .HasForeignKey(d => d.ProdId)
                .HasConstraintName("FK_dbo.AccesoriosCambioProd_dbo.Prod_ProdId");

            entity.HasOne(d => d.TipoAccesorioCambio).WithMany(p => p.AccesoriosCambioProds)
                .HasForeignKey(d => d.TipoAccesorioCambioId)
                .HasConstraintName("FK_dbo.AccesoriosCambioProd_dbo.TipoAccesorioCambio_TipoAccesorioCambioId");
        });

        modelBuilder.Entity<AccesoriosProd>(entity =>
        {
            entity.HasKey(e => e.AccesoriosProdId).HasName("PK_dbo.AccesoriosProd");

            entity.ToTable("AccesoriosProd");

            entity.HasIndex(e => e.ProdId, "IX_ProdId");

            entity.HasOne(d => d.Prod).WithMany(p => p.AccesoriosProds)
                .HasForeignKey(d => d.ProdId)
                .HasConstraintName("FK_dbo.AccesoriosProd_dbo.Prod_ProdId");
        });
        ...
        modelBuilder.Entity<AltaProduccion>(entity =>
        {
            entity.HasKey(e => e.AltaProduccionId).HasName("PK_dbo.AltaProduccion");

            entity.ToTable("AltaProduccion");

            entity.Property(e => e.CostoTotal).HasColumnType("decimal(12, 5)");
            entity.Property(e => e.FechaCreado).HasColumnType("datetime");
        });

        modelBuilder.Entity<AltaProduccionDetalle>(entity =>
        {
            entity.HasKey(e => e.AltaProduccionDetalleId).HasName("PK_dbo.AltaProduccionDetalle");

            entity.ToTable("AltaProduccionDetalle");

            entity.HasIndex(e => e.AltaProduccionId, "IX_AltaProduccionId");

            entity.Property(e => e.Cantidad).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.Costo).HasColumnType("decimal(12, 5)");

            entity.HasOne(d => d.AltaProduccion).WithMany(p => p.AltaProduccionDetalles)
                .HasForeignKey(d => d.AltaProduccionId)
                .HasConstraintName("FK_dbo.AltaProduccionDetalle_dbo.AltaProduccion_AltaProduccionId");
        });
        ...
        modelBuilder.Entity<ArchivosProducto>(entity =>
        {
            ...
            entity.Property(e => e.FecModifImg).HasColumnType("datetime");
            entity.Property(e => e.FecModifImgVol).HasColumnType("datetime");
            entity.Property(e => e.FecModifTec).HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => e.AtributoId).HasName("PK_dbo.Atributo");
        ...
        modelBuilder.Entity<AtributoProducto>(entity =>
        {
            entity.HasKey(e => e.AtributoProductoId).HasName("PK_dbo.AtributoProducto");

            entity.ToTable("AtributoProducto");

            entity.HasIndex(e => e.AtributoId, "IX_AtributoId");

            entity.HasIndex(e => e.DominioValorAtributoId, "IX_DominioValorAtributoId");

            entity.HasIndex(e => e.ProductoId, "IX_ProductoId");

            entity.Property(e => e.Valor)
                .HasMaxLength(128)
                .IsUnicode(false);

            entity.HasOne(d => d.Atributo).WithMany(p => p.AtributoProductos)
                .HasForeignKey(d => d.AtributoId)
                .HasConstraintName("FK_dbo.AtributoProducto_dbo.Atributo_AtributoId");

            entity.HasOne(d => d.DominioValorAtributo).WithMany(p => p.AtributoProductos)
                .HasForeignKey(d => d.DominioValorAtributoId)
                .HasConstraintName("FK_dbo.AtributoProducto_dbo.DominioValorAtributo_DominioValorAtributoId");

            entity.HasOne(d => d.Producto).WithMany(p => p.AtributoProductos)
                .HasForeignKey(d => d.ProductoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.AtributoProducto_dbo.Producto_ProductoId");
        });
        ...
        modelBuilder.Entity<AuxTable>(entity =>
        {
            ...
            entity.Property(e => e.AltaProduccion)
                .HasMaxLength(2)
                .IsUnicode(false)
                .HasColumnName("ALTA PRODUCCION");
            entity.Property(e => e.BajaProduccion)
                .HasMaxLength(2)
                .IsUnicode(false)
                .HasColumnName("BAJA PRODUCCION");
            entity.Property(e => e.Codigo).HasColumnName("CODIGO");
            entity.Property(e => e.CostoActual)
                .HasColumnType("decimal(38, 6)")
                .HasColumnName("COSTO ACTUAL");
            entity.Property(e => e.CostoAnterior).HasColumnName("COSTO ANTERIOR");
            entity.Property(e => e.Descripcion).HasColumnName("DESCRIPCION");
            entity.Property(e => e.EnProduccion).HasColumnName("EN PRODUCCION");
            entity.Property(e => e.GastosDeFabricacion).HasColumnType("money");
            entity.Property(e => e.ManoDeObra).HasColumnType("money");
            entity.Property(e => e.PlantillaCosto)
                .HasColumnType("decimal(12, 5)")
                .HasColumnName("PLANTILLA COSTO");
        });
        ...
        modelBuilder.Entity<BajaProduccion>(entity =>
        {
            entity.HasKey(e => e.BajaProduccionId).HasName("PK_dbo.BajaProduccion");

            entity.ToTable("BajaProduccion");

            entity.Property(e => e.CostoTotal).HasColumnType("decimal(12, 5)");
            entity.Property(e => e.FechaCreado).HasColumnType("datetime");
        });

        modelBuilder.Entity<BajaProduccionDetalle>(entity =>
        {
            entity.HasKey(e => e.BajaProduccionDetalleId).HasName("PK_dbo.BajaProduccionDetalle");

            entity.ToTable("BajaProduccionDetalle");

            entity.HasIndex(e => e.BajaProduccionId, "IX_BajaProduccionId");

            entity.Property(e => e.Cantidad).HasColumnType("decimal(12, 5)");
            entity.Property(e => e.Costo).HasColumnType("decimal(12, 5)");

            entity.HasOne(d => d.BajaProduccion).WithMany(p => p.BajaProduccionDetalles)
                .HasForeignKey(d => d.BajaProduccionId)
                .HasConstraintName("FK_dbo.BajaProduccionDetalle_dbo.BajaProduccion_BajaProduccionId");
        });
        ...
        modelBuilder.Entity<CodigoOrdenProduccion>(entity =>
        {
            entity.HasKey(e => e.CodigoOrdenProduccionId).HasName("PK_dbo.CodigoOrdenProduccion");

            entity.ToTable("CodigoOrdenProduccion");
        });

        modelBuilder.Entity<ColorProd>(entity =>
        {
            entity.HasKey(e => e.ColorProdId).HasName("PK_dbo.ColorProd");

            entity.ToTable("ColorProd");

            entity.HasIndex(e => e.ProdId, "IX_ProdId");

            entity.HasIndex(e => e.TipoColorProdId, "IX_TipoColorProdId");

            entity.HasOne(d => d.Prod).WithMany(p => p.ColorProds)
                .HasForeignKey(d => d.ProdId)
                .HasConstraintName("FK_dbo.ColorProd_dbo.Prod_ProdId");

            entity.HasOne(d => d.TipoColorProd).WithMany(p => p.ColorProds)
                .HasForeignKey(d => d.TipoColorProdId)
                .HasConstraintName("FK_dbo.ColorProd_dbo.TipoColorProd_TipoColorProdId");
        });
        ...
        modelBuilder.Entity<CostoPlantilla>(entity =>
        {
            entity.HasKey(e => e.CostoPlantillaId).HasName("PK_dbo.CostoPlantilla");

            entity.ToTable("CostoPlantilla");

            entity.HasIndex(e => e.PlantillaId, "IX_PlantillaId");

            entity.HasIndex(e => e.TipoCostoPlantillaId, "IX_TipoCostoPlantillaId");

            entity.Property(e => e.Costo1).HasColumnType("decimal(12, 5)");
            entity.Property(e => e.Costo2).HasColumnType("decimal(12, 5)");

            entity.HasOne(d => d.Plantilla).WithMany(p => p.CostoPlantillas)
                .HasForeignKey(d => d.PlantillaId)
                .HasConstraintName("FK_dbo.CostoPlantilla_dbo.Plantilla_PlantillaId");

            entity.HasOne(d => d.TipoCostoPlantilla).WithMany(p => p.CostoPlantillas)
                .HasForeignKey(d => d.TipoCostoPlantillaId)
                .HasConstraintName("FK_dbo.CostoPlantilla_dbo.TipoCostoPlantilla_TipoCostoPlantillaId");
        });
        ...
        modelBuilder.Entity<CotizacionItemsOp>(entity =>
        {
            entity.HasKey(e => e.CotizacionItemsOpid).HasName("PK_dbo.CotizacionItemsOP");

            entity.ToTable("CotizacionItemsOP");

            entity.Property(e => e.CotizacionItemsOpid).HasColumnName("CotizacionItemsOPId");
            entity.Property(e => e.FechaEntrega).HasColumnType("datetime");
            entity.Property(e => e.Opexistentes).HasColumnName("OPExistentes");
            entity.Property(e => e.Opnfinal).HasColumnName("OPNFinal");
            entity.Property(e => e.Opninicial).HasColumnName("OPNInicial");
            entity.Property(e => e.Pendiente).HasColumnType("decimal(18, 2)");
        ...
        modelBuilder.Entity<DetalleAccesorio>(entity =>
        {
            entity.HasKey(e => e.DetalleAccesorioId).HasName("PK_dbo.DetalleAccesorio");

            entity.ToTable("DetalleAccesorio");

            entity.Property(e => e.Cantidad).HasColumnType("decimal(18, 2)");
        });

        modelBuilder.Entity<DetalleAccesorioCambio>(entity =>
        {
            entity.HasKey(e => e.DetalleAccesorioCambioId).HasName("PK_dbo.DetalleAccesorioCambio");

            entity.ToTable("DetalleAccesorioCambio");
        ...
        modelBuilder.Entity<DetalleProveedorProducto>(entity =>
        {
            ...
            entity.HasOne(d => d.ProveedorProducto).WithMany(p => p.DetalleProveedorProductos)
                .HasForeignKey(d => d.ProveedorProductoId)
                .HasConstraintName("FK_dbo.DetalleProveedorProducto_dbo.ProveedorProducto_ProveedorProductoId");
        });
        ...
        modelBuilder.Entity<DominioValorAtributo>(entity =>
        {
            entity.HasKey(e => e.DominioValorAtributoId).HasName("PK_dbo.DominioValorAtributo");

            entity.ToTable("DominioValorAtributo");
            ...
            entity.HasOne(d => d.Atributo).WithMany(p => p.DominioValorAtributos)
                .HasForeignKey(d => d.AtributoId)
                .HasConstraintName("FK_dbo.DominioValorAtributo_dbo.Atributo_AtributoId");
        });
        ...
        {
            entity.HasKey(e => e.EquipamientoId).HasName("PK_dbo.Equipamiento");

            entity.ToTable("Equipamiento");

            entity.HasIndex(e => e.TipoEquipamientoId, "IX_TipoEquipamientoId");

            entity.Property(e => e.Fecha).HasColumnType("datetime");

            entity.HasOne(d => d.TipoEquipamiento).WithMany(p => p.Equipamientos)
                .HasForeignKey(d => d.TipoEquipamientoId)
                .HasConstraintName("FK_dbo.Equipamiento_dbo.TipoEquipamiento_TipoEquipamientoId");
        });

        modelBuilder.Entity<EquipamientoDetalle>(entity =>
        {
            entity.HasKey(e => e.EquipamientoDetalleId).HasName("PK_dbo.EquipamientoDetalle");

            entity.ToTable("EquipamientoDetalle");

            entity.HasIndex(e => e.EquipamientoId, "IX_EquipamientoId");

            entity.Property(e => e.Cantidad).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.FechaAlta).HasColumnType("datetime");
            entity.Property(e => e.FechaBaja).HasColumnType("datetime");

            entity.HasOne(d => d.Equipamiento).WithMany(p => p.EquipamientoDetalles)
                .HasForeignKey(d => d.EquipamientoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.EquipamientoDetalle_dbo.Equipamiento_EquipamientoId");
        });

        modelBuilder.Entity<EquipamientoProd>(entity =>
        {
            entity.HasKey(e => e.EquipamientoProdId).HasName("PK_dbo.EquipamientoProd");

            entity.ToTable("EquipamientoProd");

            entity.HasIndex(e => e.EquipamientoId, "IX_EquipamientoId");

            entity.HasIndex(e => e.ProdId, "IX_ProdId");

            entity.HasOne(d => d.Equipamiento).WithMany(p => p.EquipamientoProds)
                .HasForeignKey(d => d.EquipamientoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.EquipamientoProd_dbo.Equipamiento_EquipamientoId");

            entity.HasOne(d => d.Prod).WithMany(p => p.EquipamientoProds)
                .HasForeignKey(d => d.ProdId)
                .HasConstraintName("FK_dbo.EquipamientoProd_dbo.Prod_ProdId");
        });
        ...
        modelBuilder.Entity<MovimientoDetalle>(entity =>
        {
            ...
            entity.HasIndex(e => e.MovimientoId, "IX_MovimientoId");
        ...
        {
            entity.HasKey(e => e.OrdenProduccionId).HasName("PK_dbo.OrdenProduccion");
        ...
        modelBuilder.Entity<Parametro>(entity =>
        {
            ...
            entity.Property(e => e.PorcentajeProduccion).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.TipoCambio).HasColumnType("decimal(18, 2)");
        });
        ...
        modelBuilder.Entity<PedidoProduccion>(entity =>
        {
            entity.HasKey(e => e.PedidoProduccionId).HasName("PK_dbo.PedidoProduccion");

            entity.ToTable("PedidoProduccion");
        ...
        modelBuilder.Entity<PedidoProduccionDetalle>(entity =>
        {
            entity.HasKey(e => e.PedidoProduccionDetalleId).HasName("PK_dbo.PedidoProduccionDetalle");

            entity.ToTable("PedidoProduccionDetalle");

            entity.HasIndex(e => e.PedidoProduccionId, "IX_PedidoProduccionId");

            entity.Property(e => e.Cantidad).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.FechaPedido).HasColumnType("datetime");

            entity.HasOne(d => d.PedidoProduccion).WithMany(p => p.PedidoProduccionDetalles)
                .HasForeignKey(d => d.PedidoProduccionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.PedidoProduccionDetalle_dbo.PedidoProduccion_PedidoProduccionId");
        });
        ...
        modelBuilder.Entity<PedidoStock>(entity =>
        {
            entity.HasKey(e => e.PedidoStockId).HasName("PK_dbo.PedidoStock");

            entity.ToTable("PedidoStock");

            entity.Property(e => e.FechaPedido).HasColumnType("datetime");
        });

        modelBuilder.Entity<PedidoStockItem>(entity =>
        {
            entity.HasKey(e => e.PedidoStockItemsId).HasName("PK_dbo.PedidoStockItems");

            entity.HasIndex(e => e.PedidoStockId, "IX_PedidoStockId");
            ...
            entity.HasOne(d => d.PedidoStock).WithMany(p => p.PedidoStockItems)
                .HasForeignKey(d => d.PedidoStockId)
                .HasConstraintName("FK_dbo.PedidoStockItems_dbo.PedidoStock_PedidoStockId");
        });
        ...
        {
            entity.HasKey(e => e.PlantillaId).HasName("PK_dbo.Plantilla");
            ...
            entity.HasOne(d => d.Prod).WithMany(p => p.Plantillas)
                .HasForeignKey(d => d.ProdId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.Plantilla_dbo.Prod_ProdId");
        });

        modelBuilder.Entity<PlantillaDetalle>(entity =>
        {
            entity.HasKey(e => e.PlantillaDetalleId).HasName("PK_dbo.PlantillaDetalle");

            entity.ToTable("PlantillaDetalle");

            entity.HasIndex(e => e.PlantillaId, "IX_PlantillaId");

            entity.Property(e => e.Cantidad).HasColumnType("decimal(12, 5)");

            entity.HasOne(d => d.Plantilla).WithMany(p => p.PlantillaDetalles)
                .HasForeignKey(d => d.PlantillaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.PlantillaDetalle_dbo.Plantilla_PlantillaId");
        });

        modelBuilder.Entity<PlantillaItemsOp>(entity =>
        {
            entity.HasKey(e => e.PlantillaItemsOpid).HasName("PK_dbo.PlantillaItemsOP");

            entity.ToTable("PlantillaItemsOP");

            entity.Property(e => e.PlantillaItemsOpid).HasColumnName("PlantillaItemsOPId");
            entity.Property(e => e.Cantidad).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.PorcentajeReglas).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.PrecioBase).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.PrecioCotizacion).HasColumnType("decimal(18, 2)");
        ...
        modelBuilder.Entity<PosicionFaldon>(entity =>
        {
            entity.HasKey(e => e.PosicionFaldonId).HasName("PK_dbo.PosicionFaldon");

            entity.ToTable("PosicionFaldon");

            entity.HasIndex(e => e.ProdId, "IX_ProdId");

            entity.HasIndex(e => e.TipoPosicionFaldonId, "IX_TipoPosicionFaldonId");

            entity.HasOne(d => d.Prod).WithMany(p => p.PosicionFaldons)
                .HasForeignKey(d => d.ProdId)
                .HasConstraintName("FK_dbo.PosicionFaldon_dbo.Prod_ProdId");

            entity.HasOne(d => d.TipoPosicionFaldon).WithMany(p => p.PosicionFaldons)
                .HasForeignKey(d => d.TipoPosicionFaldonId)
                .HasConstraintName("FK_dbo.PosicionFaldon_dbo.TipoPosicionFaldon_TipoPosicionFaldonId");
        });
        ...
        modelBuilder.Entity<PreGuardadoProducto>(entity =>
        {
            ...
            entity.Property(e => e.Cantidad).HasColumnType("decimal(14, 2)");
            entity.Property(e => e.FechaCreacion).HasColumnType("datetime");
            entity.Property(e => e.Precio).HasColumnType("decimal(18, 2)");
        ...
        modelBuilder.Entity<ProductoGrafico>(entity =>
        {
            entity.HasKey(e => e.ProductoGraficoId).HasName("PK_dbo.ProductoGrafico");

            entity.ToTable("ProductoGrafico");

            entity.HasIndex(e => e.ProdId, "IX_ProdId");

            entity.HasOne(d => d.Prod).WithMany(p => p.ProductoGraficos)
                .HasForeignKey(d => d.ProdId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.ProductoGrafico_dbo.Prod_ProdId");
        });
        ...
        modelBuilder.Entity<ProveedorProdRel>(entity =>
        {
            ...
            entity.HasOne(d => d.ProveedorProducto).WithMany(p => p.ProveedorProdRels)
                .HasForeignKey(d => d.ProveedorProductoId)
                .HasConstraintName("FK_dbo.ProveedorProdRel_dbo.ProveedorProducto_ProveedorProductoId");
        });
        ...
        modelBuilder.Entity<RegistroProduccion>(entity =>
        {
            entity.HasKey(e => e.RegistroProduccionId).HasName("PK_dbo.RegistroProduccion");

            entity.ToTable("RegistroProduccion");

            entity.HasIndex(e => e.PedidoProduccionDetalleId, "IX_PedidoProduccionDetalleId");

            entity.Property(e => e.FechaProduccion).HasColumnType("datetime");
            entity.Property(e => e.FechaRegistro).HasColumnType("datetime");

            entity.HasOne(d => d.PedidoProduccionDetalle).WithMany(p => p.RegistroProduccions)
                .HasForeignKey(d => d.PedidoProduccionDetalleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.RegistroProduccion_dbo.PedidoProduccionDetalle_PedidoProduccionDetalleId");
        });
        ...
        modelBuilder.Entity<RequerimientoPedidoItem>(entity =>
        {
            ...
            entity.HasOne(d => d.RequerimientoPedido).WithMany(p => p.RequerimientoPedidoItems)
                .HasForeignKey(d => d.RequerimientoPedidoId)
                .HasConstraintName("FK_dbo.RequerimientoPedidoItems_dbo.RequerimientoPedido_RequerimientoPedidoId");
        });
        ...
        modelBuilder.Entity<SaldoInicialCliente>(entity =>
        {
            entity.HasKey(e => e.SaldoInicialClienteId).HasName("PK_dbo.SaldoInicialCliente");

            entity.ToTable("SaldoInicialCliente");

            entity.Property(e => e.Afavor)
                .HasColumnType("decimal(18, 2)")
                .HasColumnName("AFavor");
            entity.Property(e => e.EnContra).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.FechaInicial).HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<StockItemsOp>(entity =>
        {
            entity.HasKey(e => e.StockItemsOpid).HasName("PK_dbo.StockItemsOP");

            entity.ToTable("StockItemsOP");

            entity.Property(e => e.StockItemsOpid).HasColumnName("StockItemsOPId");
            entity.Property(e => e.Cantidad).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.PorcentajeReglas).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.PrecioBase).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.PrecioCotizacion).HasColumnType("decimal(18, 2)");
        ...
        modelBuilder.Entity<TipoAccesorioCambio>(entity =>
        {
            entity.HasKey(e => e.TipoAccesorioCambioId).HasName("PK_dbo.TipoAccesorioCambio");

            entity.ToTable("TipoAccesorioCambio");
        });
        ...
        modelBuilder.Entity<TipoColorProd>(entity =>
        {
            entity.HasKey(e => e.TipoColorProdId).HasName("PK_dbo.TipoColorProd");

            entity.ToTable("TipoColorProd");
        });
        ...
        modelBuilder.Entity<TipoCostoPlantilla>(entity =>
        {
            entity.HasKey(e => e.TipoCostoPlantillaId).HasName("PK_dbo.TipoCostoPlantilla");

            entity.ToTable("TipoCostoPlantilla");
        });
        ...
        modelBuilder.Entity<TipoEquipamiento>(entity =>
        {
            entity.HasKey(e => e.TipoEquipamientoId).HasName("PK_dbo.TipoEquipamiento");

            entity.ToTable("TipoEquipamiento");
        });
        ...
        modelBuilder.Entity<TipoPosicionFaldon>(entity =>
        {
            entity.HasKey(e => e.TipoPosicionFaldonId).HasName("PK_dbo.TipoPosicionFaldon");

            entity.ToTable("TipoPosicionFaldon");
        });
