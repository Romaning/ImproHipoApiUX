...
using Domain.Entities.Auxiliar;
using Microsoft.EntityFrameworkCore;

namespace Persistence.DbContexts;

public partial class ApplicationDbAuxContext : DbContext
{
    public ApplicationDbAuxContext()
    {
    }

    public ApplicationDbAuxContext(DbContextOptions<ApplicationDbAuxContext> options)
        : base(options)
    {
    ...
    public virtual DbSet<UnificacionProd> UnificacionProds { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NoConformidad>(entity =>
        {
            ...
            entity.HasOne(d => d.MovimientoDetalle).WithMany(p => p.NoConformidads)
                .HasForeignKey(d => d.MovimientoDetalleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dbo.NoConformidad_dbo.MovimientoDetalle_MovimientoDetalleId");
        });
        ...
        {
            entity.HasKey(e => e.DiagramId).HasName("PK__sysdiagr__C2B05B6139BCD0BB");
        ...
        modelBuilder.Entity<UnificacionProd>(entity =>
        {
            entity.HasKey(e => e.UnificacionProdId).HasName("PK_dbo.UnificacionProd");

            entity.ToTable("UnificacionProd");
        });
